const app = new Vue({
  ...
  data: {
    ...
    orderByMenuHidden: false, //order menu in responsive
    filterByMenuHidden: false, //filter menu in responsive
  },
  ...
  methods: {
    ...
    stockImage(e) {
      e.target.src = "css/img/notfound.png";
        ...
        //toggle the responsive hidden mode
    openHidden() {
      document.getElementById("main").classList.toggle("active");
    },

    // deactivates the responsive-menu
    deactivate() {
      document.getElementById("main").classList.remove("active");
      document.querySelector(".hidden-search").classList.remove("active");
    },

    // deactivates the input box in responsive-mode
    deactivateSearch() {
      document.querySelector(".hidden-search").classList.remove("active");
    },

    //deactivates all other active toggles in responsive mode, and enables the input box, focusing it.
    activateSearch() {
      this.orderByMenuHidden = false;
      this.filterByMenuHidden = false;
